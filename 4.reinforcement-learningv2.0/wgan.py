...
def cal_gradient_penalty(netD, real_data, fake_data, batch_size):
    ...
    alpha = np.resize(alpha, (20, 98304))
    alpha = np.resize(alpha, (20, 128, 128, 6))
